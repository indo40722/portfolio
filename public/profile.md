...
- 企画背景: 発表資料では、趣味を始めたい人が何を買えばいいか分からない、いきなり出費するのが怖い、という課題に対して、体験投稿、Q&A、レンタル後購入、本人確認などを含むサービスとしてチームで提案した。
...
- Hoppyのサービス提案全体はチームの発表内容であり、本人の担当はコミュニティ機能とサポート機能の実装です。
